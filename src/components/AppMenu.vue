  ...
  <nav class="hidden sm:flex items-center gap-3 md:gap-14">
    <router-link class="menu__item" to="/">
      <div class="absolute -bottom-1 flex items-center gap-1 w-full">
        <span
          class="border__one animated__border w-full h-0 border-emerald-300 dark:border-emerald-800 border rounded-2xl"></span>
        <span
          class="border__two animated__border w-full h-0 border-emerald-50 dark:border-gray-700 border rounded-2xl left-5"></span>
        <span
          class="border__three animated__border w-full h-0 border-emerald-300 dark:border-emerald-800 border rounded-2xl left-10"></span>
      </div>
      <span class="dark:text-neutral-200"> Filmes </span>
    </router-link>
    <button title="Em construção" disabled class="menu__item cursor-not-allowed opacity-50 dark:opacity-30" to="/lorem">
